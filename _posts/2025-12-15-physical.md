...
These use cases, as I covered in my article [*My Homelab Architecture Explained (2025 Edition)*]({{ 'posts/2025-11-19-introduction.md' | relative_url }}), are the core responsibilities that I needed my homelab to cover.  I strongly recommend you develop your use cases before you start spending money and time on your own homelab projects.  It will save you time and money and helps to make sure you're only adding components that move your lab forward.
